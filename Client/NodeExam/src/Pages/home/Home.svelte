  ...
  <div class="container mx-auto px-6 py-10">
    ...
    <div class="mt-6">
      <p class="text-gray-700 text-lg">
        Velkommen til Nordkystens Fodterapi, hvor vores passion ligger i at
        fremme sundhed gennem specialiserede indlæg og kurser. Vi er dedikerede
        til at skabe en unik oplevelse, der ikke kun adresserer dine
        fodproblemer, men også uddanner og styrker dig til at tage aktiv del i
        din fodpleje. Hos os handler det ikke kun om behandling, men også om at
        dele viden og skabe bæredygtige resultater.
      </p>
    </div>
      ...
      <div class="md:flex">
        ...
        <div class="p-8">
          ...
          <p class="mt-2 text-gray-600 text-lg">
            ...
            fødder - de er nøglen til personlig komfort og bevægelsesfrihed. Hos
            Nordkystens Fodterapi tror vi på, at hvert skridt skal være en
            behagelig oplevelse, og vores specialdesignede indlæg er skabt til
            at tilpasse sig præcist til dine unikke fodstrukturer. Uanset om du
            lider af smertefulde tilstande eller bare ønsker at forbedre din
            daglige komfort, er vores indlæg designet til at støtte din krop og
            sætte dig i stand til at bevæge dig frit og ubesværet.
          </p>
        </div>
      </div>
    </div>
